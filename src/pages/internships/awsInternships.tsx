...
/* ------------------------------------------------------------------
   2. AWS INTERNSHIP CURRICULUM & SERVICES MATRIX
--------------------------------------------------------------------- */
const awsInternshipData = [
  {
    icon: Cloud,
    title: "AWS Fundamentals & Console",
    text: "Master the AWS Management Console, cloud regions, availability zones, and core cloud architecture basics.",
    borderColor: "hover:border-orange-500/60",
    glowColor: "group-hover:bg-orange-500/10",
  },
  {
    icon: Lock,
    title: "IAM & Security Essentials",
    text: "Manage user access, roles, security groups, permissions, and identity protection in cloud environments.",
    borderColor: "hover:border-orange-500/60",
    glowColor: "group-hover:bg-orange-500/10",
  },
  {
    ...
    text: "Launch, configure, and manage elastic cloud servers (EC2 instances) for running web applications.",
    borderColor: "hover:border-orange-500/60",
    glowColor: "group-hover:bg-orange-500/10",
  },
  {
    ...
    text: "Store, retrieve, and secure static assets, backups, and user media files using AWS Simple Storage Service.",
    borderColor: "hover:border-orange-500/60",
    glowColor: "group-hover:bg-orange-500/10",
  },
  {
    ...
    text: "Set up virtual private clouds, subnets, internet gateways, and route tables for secure cloud networking.",
    borderColor: "hover:border-orange-500/60",
    glowColor: "group-hover:bg-orange-500/10",
  },
  {
    ...
    text: "Deploy and connect managed relational databases (MySQL/PostgreSQL) to cloud-hosted applications.",
    borderColor: "hover:border-orange-500/60",
    glowColor: "group-hover:bg-orange-500/10",
  },
  {
    ...
    text: "Monitor server performance metrics, set up cloud alarms, and track resource utilization logs.",
    borderColor: "hover:border-orange-500/60",
    glowColor: "group-hover:bg-orange-500/10",
  },
  {
    ...
    text: "Configure elastic load balancers and auto scaling groups to handle high traffic and high availability.",
    borderColor: "hover:border-orange-500/60",
    glowColor: "group-hover:bg-orange-500/10",
  },
];
...
const awsTargetAudiences = [
  {
    ...
    desc: "Build practical cloud engineering skills that complement your university curriculum and set you apart.",
  },
  {
    icon: GraduationCap,
    title: "Recent Graduates",
    desc: "Gain hands-on cloud project experience to bridge the gap between academic theory and job requirements.",
  },
  {
    icon: Terminal,
    title: "Aspiring Cloud Engineers",
    desc: "Start your professional cloud journey with structured mentor guidance and real-world infrastructure tasks.",
  },
  {
    icon: Award,
    title: "Developers & Beginners",
    desc: "Learn how modern software applications are deployed, scaled, and managed on the AWS cloud platform.",
  },
];
...
const awsPricingPlans = [
  {
    id: "aws-starter-internship",
    title: "AWS Cloud Starter Internship",
    price: "₹6,999 / program",
    description: "Foundational cloud internship program covering core AWS services, EC2, S3, and IAM basics.",
    duration: "4 Weeks Program",
    level: "Beginner Friendly",
    features: [
      "Introduction to Cloud Computing & AWS",
      "Hands-on EC2 & S3 configuration",
      "IAM security & user management",
      "Basic website hosting on AWS",
      "Mentor guidance & completion certificate"
    ],
    highlighted: false,
  },
  {
    id: "aws-pro-internship",
    title: "AWS Pro Cloud Engineer Internship",
    price: "₹9,999 / program",
    description: "Comprehensive practical internship with advanced networking, databases, auto-scaling, and live projects.",
    duration: "6 Weeks Program",
    level: "Intermediate Level",
    features: [
      "Advanced VPC, Subnets & Networking",
      "RDS database integration & management",
      "CloudWatch monitoring & Auto Scaling",
      "Full project deployment on AWS cloud",
      "Real-world architecture scenarios & review"
    ],
    highlighted: true,
  },
  {
    id: "aws-custom-mentorship",
    title: "1-on-1 Cloud Mentorship",
    price: "₹1,999 / week",
    description: "Personalized 1-on-1 cloud training and project support tailored to your exact learning speed and goals.",
    duration: "Flexible Schedule",
    level: "Customized",
    features: [
      "Dedicated 1-on-1 cloud mentor",
      "Customized cloud lab exercises",
      "Direct doubt clearing & troubleshooting",
      "Career roadmap & resume guidance",
...
const AwsInternshipServices = () => {
  ...
  const handleWhatsAppClick = (planTitle?: string) => {
    ...
    const messageText = planTitle 
      ? `Hello TechSasi, I am interested in joining the '${planTitle}' AWS Internship program. Let's start my cloud journey!`
      : `Hello TechSasi, I want to join the AWS Internship program and learn cloud computing. Let's discuss details!`;
  ...
  const handleDmSubmit = (e: React.FormEvent) => {
    ...
    const phoneNumber = "7448788897";
    const encodedMsg = encodeURIComponent(`Hello TechSasi, here are my AWS internship goals and background:\n\n"${dmMessage}"`);
          ...
          <div className="container-custom max-w-5xl px-6 lg:px-12 text-center relative z-10 mx-auto">
            ...
            >
              <span className="inline-block px-4 py-1.5 rounded-full bg-orange-500/10 border border-orange-500/30 text-orange-400 font-semibold text-xs tracking-wider uppercase mb-6 shadow-sm">
                Practical Cloud Project Training
              </span>
              ...
              <h1 className="text-4xl sm:text-6xl xl:text-7xl font-heading font-black uppercase mb-6 tracking-tight leading-tight text-white">
                Learn AWS by Working on <span className="bg-gradient-to-r from-orange-400 via-amber-400 to-orange-500 bg-clip-text text-transparent">Real Projects</span>
              </h1>

              <p className="text-lg sm:text-xl text-zinc-300 mb-10 max-w-2xl mx-auto leading-relaxed font-light">
                Interested in Cloud Computing and want to learn how AWS is actually used in real-world projects? Move beyond theory and gain practical exposure to cloud technologies.
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-4 items-center">
                ...
                >
                  Join AWS Internship <ArrowRight size={18} className="transform group-hover:translate-x-1 transition-transform" />
                </button>
        ...
        <section className="py-24 bg-zinc-950/95 border-b border-zinc-900 relative backdrop-blur-md">
          ...
          >
            <p className="text-2xl md:text-3xl font-medium leading-relaxed text-zinc-200">
              At TechSasi, our AWS Internship program is designed to help students and beginners gain practical exposure to cloud technologies.{" "}
              <span className="bg-gradient-to-r from-orange-400 to-amber-400 bg-clip-text text-transparent font-bold">
                You'll learn AWS fundamentals, work with commonly used cloud services, and build real-world project experience.
              </span>
            </p>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-stretch">
              ...
              <div ref={reveal} className="blur-reveal bg-zinc-900/80 border border-zinc-800 p-8 md:p-10 rounded-2xl shadow-md flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-zinc-300 text-sm leading-relaxed mb-6">
                    Reading about cloud computing is completely different from actually working with it. During the internship, you'll perform practical tasks, understand cloud environments, and work through real-world scenarios where different AWS services collaborate.
                  </p>
                </div>
                <div className="bg-zinc-950 p-4 rounded-xl border border-zinc-800 text-xs text-zinc-300 flex items-center gap-3">
                  ...
                  <span>Real AWS console experience instead of theoretical memorization.</span>
                </div>
              </div>
              ...
              <div ref={reveal} className="blur-reveal bg-zinc-900/80 border border-zinc-800 p-8 md:p-10 rounded-2xl shadow-md flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-zinc-300 text-sm leading-relaxed mb-6">
                    We believe projects are the best way to master technology. Depending on your learning level, you will work on projects such as deploying a website on AWS, hosting web apps on EC2, storing files in S3, and connecting applications with databases.
                  </p>
                </div>
                <div className="bg-zinc-950 p-4 rounded-xl border border-zinc-800 text-xs text-zinc-300">
                  Deploy websites, configure cloud storage, and build secure cloud networks.
                </div>
              </div>
        ...
        <section className="py-32 bg-black/90 border-b border-zinc-900 backdrop-blur-md">
          <div className="container-custom max-w-7xl px-6 lg:px-12 mb-16 text-center">
            ...
            <p className="text-lg text-zinc-300 max-w-xl mx-auto">
              You don't need to be an AWS expert to get started. Basic computer knowledge and curiosity are enough.
            </p>
          </div>
          ...
          <div className="container-custom max-w-5xl px-6 lg:px-12 text-center">
            <div ref={reveal} className="blur-reveal bg-zinc-900/80 border border-zinc-800 p-10 md:p-14 rounded-3xl shadow-xl">
              ...
              <div className="grid sm:grid-cols-2 gap-6 text-left mb-8">
                {[
                  { title: "Practical Exposure", desc: "Work directly with AWS cloud services instead of studying only theory." },
                  { title: "Project Experience", desc: "Build and complete practical cloud-based deployment projects." },
                  { title: "System Understanding", desc: "Understand how servers, storage, databases, and networking work together." },
                  { title: "Career Preparation", desc: "Build foundational cloud knowledge to support your future tech career." }
                ].map((gain, i) => (
              ...
              <div className="p-4 bg-orange-500/10 border border-orange-500/30 rounded-xl text-orange-300 text-xs font-semibold uppercase tracking-wider">
                Learn Concepts $\rightarrow$ Practice Technology $\rightarrow$ Build Projects $\rightarrow$ Understand Real-World Usage
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="internship-programs" className="py-32 bg-black/90 border-b border-zinc-900 backdrop-blur-md">
          <div className="container-custom max-w-7xl px-6 lg:px-12">
            <div ref={reveal} className="blur-reveal mb-16 text-center lg:text-left">
              ...
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-white mb-4">
                AWS Internship <span className="text-orange-400">Tiers & Pricing</span>
              </h2>
              <p className="text-lg text-zinc-300 max-w-xl">
                Choose an internship plan that fits your schedule and goals. Click any program to review details and connect via WhatsApp.
              </p>
            </div>
            ...
            >
              ...
              <div className="text-center mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-heading font-bold mb-3 text-white">
                  Ready to Start Your <span className="text-orange-400">AWS Journey?</span>
                </h2>
                <p className="text-zinc-300 text-sm max-w-lg mx-auto">
                  If Cloud Computing interests you, send us a quick message via WhatsApp DM (+91 7448788897) to apply for the internship.
                </p>
              </div>
                ...
                <form onSubmit={handleDmSubmit} className="space-y-4">
                  <div className="relative">
                    <textarea
                      ...
                      placeholder="Share your background (student/graduate), your current cloud knowledge, and why you want to join the AWS internship..."
          ...
          <div className="container-custom max-w-7xl px-6 lg:px-12">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4 text-white">
                Start Building Your AWS Skills Today
              </h2>
              <p className="mb-10 text-zinc-300 max-w-xl mx-auto leading-relaxed">
                Join <span className="text-orange-400 font-bold">TechSasi</span> and start building your cloud engineering skills through practical project-based learning.
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                >
                  Join AWS Internship <ArrowRight size={18} />
                </button>
...
export default AwsInternshipServices;