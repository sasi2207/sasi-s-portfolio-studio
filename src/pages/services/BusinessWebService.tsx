            ...
            <div className="grid sm:grid-cols-2 gap-5">
              {[
                ...
                <div
                  key={item}
                  ref={reveal}
                  className="blur-reveal bg-zinc-900/60 border border-zinc-800 p-5 rounded-2xl flex items-center gap-3 text-white hover:border-orange-500/50 transition duration-300"
                >
          ...
          <div className="container-custom max-w-7xl px-6 lg:px-12 relative z-10">
            <div ref={reveal} className="blur-reveal mb-20 text-center max-w-3xl mx-auto">
              ...
              <p className="text-lg text-zinc-300">
                A structured process designed by <span className="text-orange-400 font-semibold">TechSasi</span> to deliver reliable business websites.
              </p>
            </div>
        ...
        <section className="py-32 bg-black/80 border-t border-zinc-900 backdrop-blur-md">
          <div className="container-custom max-w-7xl px-6 lg:px-12">
            <div ref={reveal} className="blur-reveal mb-16 text-center lg:text-left">
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-white mb-4">
                Business Website <span className="text-orange-400">Pricing</span>
              </h2>
          ...
          <div className="container-custom max-w-7xl px-6 lg:px-12">
            ...
            >
              ...
              <p className="mb-10 text-zinc-300 max-w-xl mx-auto leading-relaxed">
                Let’s create a professional business website that drives growth. You focus on your business. <span className="text-orange-400 font-bold">TechSasi</span> will take care of your website.
              </p>
