...
export const DynamicWebService = () => {
  return (
    <PageLayout>
      <div id="dynamic-web" className="min-h-screen bg-slate-950 text-slate-200 pt-32 pb-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden font-sans selection:bg-purple-500/30">
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <div className="p-3 bg-slate-950 border border-slate-900 rounded-xl shadow-inner text-slate-400 group-hover:text-purple-500 transition-colors">
                      {item.icon}
                    </div>
